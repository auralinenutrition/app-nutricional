...
function Signup() {
    ...
    const { signUp: signUpCtx } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])(); // NÃO usar para criar conta
    ...
    const handleSignup = async ()=>{
        try {
            ...
            if (!userId) {
                const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                userId = session.data.session?.user?.id ?? undefined;
                if (!userId) throw new Error("ID do usuário não encontrado.");
            }
            // 2) DEFINIR PLANO
            const planoSelecionado = new URLSearchParams(window.location.search).get("plano") ?? "free";
            // 3) INSERIR USUÁRIO NA TABELA users
            const { error: insertUserError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("users").insert({
                id: userId,
                name: nome,
                email: email,
            ...
            if (!saveRes.success) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("quiz_responses").insert({
                    user_id: userId,
                    ...payload,
                    created_at: new Date().toISOString()
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bca738c3._.js.map