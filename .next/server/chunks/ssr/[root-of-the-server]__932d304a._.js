module.exports = {
  "[project]/src/components/ui/AInput.tsx [app-ssr] (ecmascript)": (
          ...
          children: [
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
              ...
              "input",
              {
                ...props,
                className:
                  "w-full px-4 py-3 rounded-xl bg-[#F5F5F5] outline-none border border-transparent focus:border-[#00C974] transition-all",
              },
              void 0,
              false,
              {
  ...
  "[project]/src/components/ui/AButton.tsx [app-ssr] (ecmascript)": (
    __turbopack_context__
  ) => {
    "use strict";
    ...
    function AButton({ children, type = "button", onClick }) {
      ...
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        ...
        "button",
        {
          ...
          onClick: onClick,
          className:
            "w-full bg-[#00C974] text-white py-3 rounded-xl font-semibold text-lg active:scale-[0.98] transition-all",
          children: children,
        },
        void 0,
        false,
  ...
  "[project]/src/app/signup/page.tsx [app-ssr] (ecmascript)": (
    __turbopack_context__
  ) => {
    "use strict";
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/src/contexts/AuthContext.tsx [app-ssr] (ecmascript)"
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$AInput$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/src/components/ui/AInput.tsx [app-ssr] (ecmascript)"
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$AButton$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/src/components/ui/AButton.tsx [app-ssr] (ecmascript)"
      );
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/src/lib/supabase.ts [app-ssr] (ecmascript)"
      );
    ("use client");
    function Signup() {
      const { signUp } = (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        "useAuth"
      ])();
      const router = (0,
      ...
      const handleSignup = async () => {
        try {
          ...
          const { data, error } =
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
              "supabase"
            ].auth.signUp({
              email,
              password: senha,
          ...
          if (!userId) {
            ...
            if (!uid)
              throw new Error(
                "Não foi possível obter ID do usuário após signUp."
              );
          ...
          const planoQuery = ("TURBOPACK compile-time falsy", 0)
          ...
          if (!quizDataString) {
            ...
            console.warn(
              "Quiz não encontrado no localStorage — usuário criado sem quiz."
            );
            router.push("/home");
            return;
          }
          ...
          if (updateErr) {
            console.warn(
              "Erro ao atualizar user com campos do quiz:",
              updateErr
            );
          }
                  ...
                  "div",
                  {
                    ...
                    children: [
                      ...
                      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$AInput$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                          "default"
                        ],
                        {
                          label: "Nome",
                      ...
                      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$AButton$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                          "default"
                        ],
                        {
                          type: "button",
                          ...
                          children: [
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                              ...
                              "span",
                              {
                                ...
                                className:
                                  "text-[#00C974] font-semibold cursor-pointer",
                                children: "Entrar",
                              },
                              void 0,
                              false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__932d304a._.js.map
