...
"[project]/src/services/meals/analyzeMeal.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function uploadMealPhoto(userId, file) {
    ...
    // Faz upload real
    const { error: uploadErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("user-uploads").upload(filePath, file, {
        upsert: false
    });
    ...
    return {
        filePath,
        publicUrl: data.publicUrl // ← URL usada na IA
    };
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$meals$2f$analyzeMeal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/meals/analyzeMeal.ts [app-ssr] (ecmascript)");
...
;
;
function MealModal({ open, onClose, onSubmit }) {
    ...
    async function handleSubmit() {
        ...
        const nutritionalData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$meals$2f$analyzeMeal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["analyzeMeal"])(publicUrl);
        console.log("🍽️ Resultado da IA:", nutritionalData);
        onSubmit?.(nutritionalData);
    }
    if (!open) return null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f3cb92f0._.js.map