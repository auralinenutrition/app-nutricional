...
async function uploadMealPhoto(userId, file) {
    ...
    const fileName = "".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])(), ".").concat(fileExt);
    const filePath = "".concat(userId, "/meal-photos/").concat(fileName);
    // Faz upload real
    const { error: uploadErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("user-uploads").upload(filePath, file, {
        upsert: false
    });
    if (uploadErr) throw uploadErr;
    // Gera URL pública
    const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("user-uploads").getPublicUrl(filePath);
    return {
        filePath,
...
function MealModal(param) {
    ...
    async function handleSubmit() {
        ...
        const { publicUrl } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$meals$2f$uploadMealPhoto$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadMealPhoto"])(user.id, file);
...
_s(MealModal, "+37L+z52bkEGmDoDJOUT+k9+vqw=");
_c = MealModal;
var _c;
...
//# sourceMappingURL=src_61824de6._.js.map