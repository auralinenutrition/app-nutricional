...
function DailyGoals(param) {
    let { water, meals, calories } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(WeeklyPlan, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
async function loadDailyProgress(userId) {
    try {
        ...
        // -----------------------
        const startDay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])().startOf("day").toISOString();
        const endDay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])().endOf("day").toISOString();
        // -----------------------
        ...
        // -----------------------
        const { data: mealRecords } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("meals").select("id").eq("user_id", userId).gte("created_at", startDay).lte("created_at", endDay);
        ...
        // -----------------------
        const { data: caloriesRecords } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("meals").select("calories").eq("user_id", userId).gte("created_at", startDay).lte("created_at", endDay);
        var _caloriesRecords_reduce;
        const totalCalories = (_caloriesRecords_reduce = caloriesRecords === null || caloriesRecords === void 0 ? void 0 : caloriesRecords.reduce((sum, m)=>{
            var _m_calories;
            return sum + ((_m_calories = m.calories) !== null && _m_calories !== void 0 ? _m_calories : 0);
        }, 0)) !== null && _caloriesRecords_reduce !== void 0 ? _caloriesRecords_reduce : 0;
        return {
...
"[project]/src/services/home/MealPlanService.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/dayjs/dayjs.min.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$home$2f$MealPlanService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/home/MealPlanService.tsx [app-client] (ecmascript)");
;
;
;
async function loadTodayMeals(userId) {
    try {
        ...
        // -------------------------------
        const { data: plan } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("ai_generated_meal_plan").select("week_start, days").eq("user_id", userId).order("week_start", {
            ascending: false
        }).limit(1).single();
        ...
        if ((plan === null || plan === void 0 ? void 0 : plan.days) && plan.days[todayKey]) {
            ...
            // -------------------------------
            const mock = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$home$2f$MealPlanService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadWeeklyPlanMock"])();
            var _mock_todayKey;
        ...
        // -------------------------------
        const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])().startOf("day").toISOString();
        const end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])().endOf("day").toISOString();
        ...
        const mealsByTitle = (userMeals !== null && userMeals !== void 0 ? userMeals : []).reduce((map, meal)=>{
            map[meal.title] = meal;
            return map;
        }, {});
        // -------------------------------
...
function HomePage() {
    ...
    const [waterPct, setWaterPct] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [mealsPct, setMealsPct] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            ...
            async function loadData() {
                // metas diárias
                const progress = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$home$2f$loadDailyProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(user.id);
                setWaterPct(progress.water);
                setMealsPct(progress.meals);
                setCalories(progress.caloriesValue);
                // refeições do dia
                const todayMeals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$home$2f$loadTodayMeals$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(user.id);
                setMeals(todayMeals);
            }
            loadData();
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$home$2f$WeeklyPlan$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/src/app/home/page.tsx",
                lineNumber: 73,
                columnNumber: 7
            }, this),
...
_s(HomePage, "EOFBMvO24Q4135EA/SXi+QN9tRQ=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=src_f85914ec._.js.map