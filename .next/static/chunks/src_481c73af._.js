...
function HomePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            if (!user) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$home$2f$loadDailyProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(user.id).then({
            ...
            loadTodayMeals(user.id).then({
                "HomePage.useEffect": (list)=>{
                    setMeals(list);
                }
            }["HomePage.useEffect"]);
        }
...
//# sourceMappingURL=src_481c73af._.js.map