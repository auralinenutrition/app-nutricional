...
function QuizPage() {
    ...
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])(); // ← pega o usuário logado
    const totalSteps = 22;
    ...
    const finalizarQuiz = async ()=>{
        ...
        const saved = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].saveQuizResponses(user.id, payload);
        if (!saved.success) {
            alert("Erro ao salvar o quiz: " + saved.error);
            return;
        }
        // 2) Atualizar usuário com dados essenciais
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].updateUserFromQuiz(user.id, payload);
        // 3) Criar projeção
        const projection = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].calculateWeightProjection(payload.peso_atual, payload.peso_desejado, 12);
        // 4) Gerar benefícios motivacionais
        const benefits = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].generateMotivationalBenefits(payload);
...
//# sourceMappingURL=src_68aa1c97._.js.map