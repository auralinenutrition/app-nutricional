...
"use client";
;
const AppModalContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function AppModalProvider(param) {
    ...
    function openMeal(data) {
        setModal("meal");
        setData(data !== null && data !== void 0 ? data : null);
    }
    function openWater(data) {
        setModal("water");
        setData(data !== null && data !== void 0 ? data : null);
    }
    function openWeight(data) {
        setModal("weight");
        setData(data !== null && data !== void 0 ? data : null);
    }
...
_s(AppModalProvider, "VKk+cYIEizCe6KOq1NZYYvrcZ2M=");
_c = AppModalProvider;
function useAppModal() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(AppModalContext);
    if (!ctx) {
        throw new Error("useAppModal must be used inside <AppModalProvider>");
    }
    return ctx;
}
_s1(useAppModal, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
...
//# sourceMappingURL=src_ce2e2689._.js.map