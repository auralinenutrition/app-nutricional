...
async function loadTodayMeals(userId) {
    try {
        ...
        const mapped = order.map((ref)=>{
            ...
            if (userMeal) {
                var _userMeal_calories, _ref;
                return {
                    title: ref,
                    description: userMeal.description,
                    calories: (_ref = (_userMeal_calories = userMeal.calories) !== null && _userMeal_calories !== void 0 ? _userMeal_calories : aiMeal === null || aiMeal === void 0 ? void 0 : aiMeal.calories) !== null && _ref !== void 0 ? _ref : 0,
                    done: true
                };
            }
            if (aiMeal) {
...
//# sourceMappingURL=src_b00de0c9._.js.map