...
function EditProfilePage() {
    ...
    const [metaAgua, setMetaAgua] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [metaCalorias, setMetaCalorias] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [metaRefeicoes, setMetaRefeicoes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditProfilePage.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").select("*").eq("id", user.id).single().then({
                "EditProfilePage.useEffect": (param)=>{
                    let { data } = param;
                    if (!data) return;
                    setProfile(data);
                    var _data_name;
                    ...
                    var _data_meta_agua;
                    setMetaAgua((_data_meta_agua = data.meta_agua) !== null && _data_meta_agua !== void 0 ? _data_meta_agua : "");
                    var _data_meta_calorias;
                    setMetaCalorias((_data_meta_calorias = data.meta_calorias) !== null && _data_meta_calorias !== void 0 ? _data_meta_calorias : "");
                    var _data_meta_refeicoes;
                    setMetaRefeicoes((_data_meta_refeicoes = data.meta_refeicoes) !== null && _data_meta_refeicoes !== void 0 ? _data_meta_refeicoes : "");
                    var _data_photo_url;
                    setPreview((_data_photo_url = data.photo_url) !== null && _data_photo_url !== void 0 ? _data_photo_url : null);
                }
            }["EditProfilePage.useEffect"]);
        }
    }["EditProfilePage.useEffect"], [
    ...
    const handleSave = async ()=>{
        ...
        if (photo) {
            ...
            const filePath = "profiles/".concat(user.id, ".").concat(fileExt);
            const { error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("user-uploads").upload(filePath, photo, {
                upsert: true
            });
            if (!uploadError) {
...
_s(EditProfilePage, "DTIPOKGFB7p9IFCfGXOuAWLP8a8=", false, function() {
    return [
...
//# sourceMappingURL=_7d35379b._.js.map