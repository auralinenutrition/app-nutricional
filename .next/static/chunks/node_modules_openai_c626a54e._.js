...
class LineDecoder {
    ...
    decodeText(bytes) {
        ...
        if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"] !== 'undefined') {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Unexpected: received non-Uint8Array (".concat(bytes.constructor.name, ') stream chunk in an environment with a global "Buffer" defined, which this library assumes to be Node. Please report this error.'));
        }
        // Browser
        if (typeof TextDecoder !== 'undefined') {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Unexpected: received non-Uint8Array/ArrayBuffer (".concat(bytes.constructor.name, ") in a web platform. Please report this error."));
        }
...
async function defaultParseResponse(props) {
    ...
    const mediaType = contentType === null || contentType === void 0 ? void 0 : (_contentType_split_ = contentType.split(';')[0]) === null || _contentType_split_ === void 0 ? void 0 : _contentType_split_.trim();
...
class APIClient {
    ...
    methodRequest(method, path, opts) {
        return this.request(Promise.resolve(opts).then(async (opts)=>{
            const body = opts && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isBlobLike"])(opts === null || opts === void 0 ? void 0 : opts.body) ? new DataView(await opts.body.arrayBuffer()) : (opts === null || opts === void 0 ? void 0 : opts.body) instanceof DataView ? opts.body : (opts === null || opts === void 0 ? void 0 : opts.body) instanceof ArrayBuffer ? new DataView(opts.body) : opts && ArrayBuffer.isView(opts === null || opts === void 0 ? void 0 : opts.body) ? new DataView(opts.body.buffer) : opts === null || opts === void 0 ? void 0 : opts.body;
            return {
                method,
                path,
                ...opts,
    ...
    buildRequest(inputOptions) {
        ...
        options.timeout = (_options_timeout = options.timeout) !== null && _options_timeout !== void 0 ? _options_timeout : this.timeout;
        var _options_httpAgent, _ref;
        const httpAgent = (_ref = (_options_httpAgent = options.httpAgent) !== null && _options_httpAgent !== void 0 ? _options_httpAgent : this.httpAgent) !== null && _ref !== void 0 ? _ref : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_shims$2f$registry$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultAgent"])(url);
    ...
    stringifyQuery(query) {
        return Object.entries(query).filter((param)=>{
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Cannot stringify type ".concat(typeof value, "; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case."));
        }).join('&');
    }
    ...
    getUserAgent() {
        return "".concat(this.constructor.name, "/JS ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$version$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VERSION"]);
    }
    constructor({ baseURL, maxRetries = 2, timeout = 600000, httpAgent, fetch: overriddenFetch }){
        ...
        this.fetch = overriddenFetch !== null && overriddenFetch !== void 0 ? overriddenFetch : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_shims$2f$registry$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetch"];
    }
}
class AbstractPage {
    hasNextPage() {
...
const validatePositiveInteger = (name, n)=>{
    if (typeof n !== 'number' || !Number.isInteger(n)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("".concat(name, " must be an integer"));
    }
    if (n < 0) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("".concat(name, " must be a positive integer"));
    }
    return n;
};
...
const ensurePresent = (value)=>{
    if (value == null) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Expected a value to be given but received ".concat(value, " instead."));
    return value;
};
const readEnv = (env)=>{
    if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== 'undefined') {
        ...
        return (_process_env_env_trim = (_process_env = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env) === null || _process_env === void 0 ? void 0 : (_process_env_env = _process_env[env]) === null || _process_env_env === void 0 ? void 0 : _process_env_env.trim()) !== null && _process_env_env_trim !== void 0 ? _process_env_env_trim : undefined;
    }
...
const coerceInteger = (value)=>{
    ...
    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Could not coerce ".concat(value, " (type: ").concat(typeof value, ") into a number"));
};
...
function debug(action) {
    ...
    if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== 'undefined' && ((_process = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]) === null || _process === void 0 ? void 0 : (_process_env = _process.env) === null || _process_env === void 0 ? void 0 : _process_env['DEBUG']) === 'true') {
...
class Messages extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
    list(completionId) {
        ...
        return this._client.getAPIList("/chat/completions/".concat(completionId, "/messages"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resources$2f$chat$2f$completions$2f$completions$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChatCompletionStoreMessagesPage"], {
            query,
            ...options
        });
    }
...
class Completions extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(completionId, options) {
        return this._client.get("/chat/completions/".concat(completionId), options);
    }
    /**
     ...
     */ update(completionId, body, options) {
        return this._client.post("/chat/completions/".concat(completionId), {
            body,
            ...options
        });
    }
     ...
     */ del(completionId, options) {
        return this._client.delete("/chat/completions/".concat(completionId), options);
    }
    constructor(){
        super(...arguments);
...
class Embeddings extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(body, options) {
        ...
        if (hasUserProvidedEncodingFormat) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["debug"]('Request', 'User defined encoding_format:', body.encoding_format);
        }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["debug"]('response', 'Decoding base64 embeddings to float32 array');
        return response._thenUnwrap((response)=>{
            if (response && response.data) {
                response.data.forEach((embeddingBase64Obj)=>{
                    const embeddingBase64Str = embeddingBase64Obj.embedding;
                    embeddingBase64Obj.embedding = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toFloat32Array"](embeddingBase64Str);
                });
            }
            return response;
        });
...
class Files extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     * storage limits.
     */ create(body, options) {
        return this._client.post('/files', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["multipartFormRequestOptions"]({
            body,
            ...options
        }));
    }
...
class Images extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ createVariation(body, options) {
        return this._client.post('/images/variations', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["multipartFormRequestOptions"]({
            body,
            ...options
        }));
    }
     ...
     * ```
     */ edit(body, options) {
        return this._client.post('/images/edits', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["multipartFormRequestOptions"]({
            body,
            ...options
        }));
    }
...
class Transcriptions extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
    create(body, options) {
        var _body_stream;
        return this._client.post('/audio/transcriptions', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["multipartFormRequestOptions"]({
            body,
            ...options,
            stream: (_body_stream = body.stream) !== null && _body_stream !== void 0 ? _body_stream : false,
            __metadata: {
...
class Translations extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
    create(body, options) {
        return this._client.post('/audio/translations', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["multipartFormRequestOptions"]({
            body,
            ...options,
            __metadata: {
                model: body.model
...
class Permissions extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(fineTunedModelCheckpoint, body, options) {
        return this._client.getAPIList("/fine_tuning/checkpoints/".concat(fineTunedModelCheckpoint, "/permissions"), PermissionCreateResponsesPage, {
            body,
            method: 'post',
            ...options
        });
    ...
    retrieve(fineTunedModelCheckpoint) {
        ...
        return this._client.get("/fine_tuning/checkpoints/".concat(fineTunedModelCheckpoint, "/permissions"), {
            query,
            ...options
        });
    }
     ...
     */ del(fineTunedModelCheckpoint, permissionId, options) {
        return this._client.delete("/fine_tuning/checkpoints/".concat(fineTunedModelCheckpoint, "/permissions/").concat(permissionId), options);
    }
}
...
class Jobs extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ pause(fineTuningJobId, options) {
        return this._client.post("/fine_tuning/jobs/".concat(fineTuningJobId, "/pause"), options);
    }
    /**
     ...
     */ resume(fineTuningJobId, options) {
        return this._client.post("/fine_tuning/jobs/".concat(fineTuningJobId, "/resume"), options);
    }
    constructor(){
        super(...arguments);
...
class Files extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ update(vectorStoreId, fileId, body, options) {
        return this._client.post("/vector_stores/".concat(vectorStoreId, "/files/").concat(fileId), {
            body,
            ...options,
            headers: {
                'OpenAI-Beta': 'assistants=v2',
     ...
     */ content(vectorStoreId, fileId, options) {
        return this._client.getAPIList("/vector_stores/".concat(vectorStoreId, "/files/").concat(fileId, "/content"), FileContentResponsesPage, {
            ...options,
            headers: {
                'OpenAI-Beta': 'assistants=v2',
                ...options === null || options === void 0 ? void 0 : options.headers
...
class FileBatches extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
    ...
    listFiles(vectorStoreId, batchId) {
        ...
        return this._client.getAPIList("/vector_stores/".concat(vectorStoreId, "/file_batches/").concat(batchId, "/files"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resources$2f$vector$2d$stores$2f$files$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VectorStoreFilesPage"], {
            query,
            ...options,
            headers: {
                'OpenAI-Beta': 'assistants=v2',
...
class VectorStores extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ search(vectorStoreId, body, options) {
        return this._client.getAPIList("/vector_stores/".concat(vectorStoreId, "/search"), VectorStoreSearchResponsesPage, {
            body,
            method: 'post',
            ...options,
            headers: {
...
function validateInputTools(tools) {
    for (const tool of tools !== null && tools !== void 0 ? tools : []){
        if (tool.type !== 'function') {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Currently only `function` tool types support auto-parsing; Received `".concat(tool.type, "`"));
        }
        if (tool.function.strict !== true) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("The `".concat(tool.function.name, "` tool is not marked with `strict: true`. Only strict function tools can be auto-parsed"));
        }
    }
...
_AbstractChatCompletionRunner_instances = new WeakSet(), _AbstractChatCompletionRunner_getFinalContent = function _AbstractChatCompletionRunner_getFinalContent() {
    ...
    for(let i = this.messages.length - 1; i >= 0; i--){
        ...
        const message = this.messages[i];
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$chatCompletionUtils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAssistantMessage"])(message) && (message === null || message === void 0 ? void 0 : message.function_call)) {
            return message.function_call;
        }
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$chatCompletionUtils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAssistantMessage"])(message) && (message === null || message === void 0 ? void 0 : (_message_tool_calls = message.tool_calls) === null || _message_tool_calls === void 0 ? void 0 : _message_tool_calls.length)) {
    ...
    for(let i = this.messages.length - 1; i >= 0; i--){
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$chatCompletionUtils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isToolMessage"])(message) && message.content != null && typeof message.content === 'string' && this.messages.some((x)=>{
            var _x_tool_calls;
    ...
    [(_ChatCompletionStream_params = new WeakMap(), _ChatCompletionStream_choiceEventStates = new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = new WeakMap(), _ChatCompletionStream_instances = new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest() {
        ...
        if (toolCallSnapshot.type === 'function') {
            ...
            this._emit('tool_calls.function.arguments.done', {
                ...
                index: toolCallIndex,
                arguments: toolCallSnapshot.function.arguments,
                parsed_arguments: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$parser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAutoParsableTool"])(inputTool) ? inputTool.$parseRaw(toolCallSnapshot.function.arguments) : (inputTool === null || inputTool === void 0 ? void 0 : inputTool.function.strict) ? JSON.parse(toolCallSnapshot.function.arguments) : null
            });
        } else {
...
function finalizeChatCompletion(snapshot, params) {
    ...
    const completion = {
        ...
        choices: choices.map((param)=>{
            ...
            if (!finish_reason) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing finish_reason for choice ".concat(index));
            }
            const { content = null, function_call, tool_calls, ...messageRest } = message;
            const role = message.role; // this is what we expect; in theory it could be different which would make our types a slight lie but would be fine.
            if (!role) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing role for choice ".concat(index));
            }
            if (function_call) {
                const { arguments: args, name } = function_call;
                if (args == null) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing function_call.arguments for choice ".concat(index));
                }
                if (!name) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing function_call.name for choice ".concat(index));
                }
                ...
                return {
                    ...
                    message: {
                        ...
                        tool_calls: tool_calls.map((tool_call, i)=>{
                            ...
                            if (id == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].id\n").concat(str(snapshot)));
                            }
                            if (type == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].type\n").concat(str(snapshot)));
                            }
                            if (name == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].function.name\n").concat(str(snapshot)));
                            }
                            if (args == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].function.arguments\n").concat(str(snapshot)));
                            }
                            return {
                                ...toolRest,
                                id,
    ...
    static accumulateDelta(acc, delta) {
        for (const [key, deltaValue] of Object.entries(delta)){
            ...
            if (typeof accValue === 'string' && typeof deltaValue === 'string') {
                ...
                accValue += deltaValue;
            } else if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isObj"](accValue) && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isObj"](deltaValue)) {
                ...
                for (const deltaEntry of deltaValue){
                    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isObj"](deltaEntry)) {
...
class Parts extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(uploadId, body, options) {
        return this._client.post("/uploads/".concat(uploadId, "/parts"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["multipartFormRequestOptions"]({
            body,
            ...options
        }));
    }
...
function hasAutoParseableInput(params) {
    var _params_text;
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$parser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAutoParsableResponseFormat"])((_params_text = params.text) === null || _params_text === void 0 ? void 0 : _params_text.format)) {
        return true;
    }
    return false;
}
...
class InputItems extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
    list(responseId) {
        ...
        return this._client.getAPIList("/responses/".concat(responseId, "/input_items"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resources$2f$responses$2f$responses$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponseItemsPage"], {
            query,
            ...options
        });
    }
...
class ResponseStream extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$EventStream$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventStream"] {
    ...
    async _createOrRetrieveResponse(client, params, options) {
        ...
        if ('response_id' in params) {
            ...
            var _params_starting_after;
            starting_after = (_params_starting_after = params.starting_after) !== null && _params_starting_after !== void 0 ? _params_starting_after : null;
        } else {
    ...
    [(_ResponseStream_params = new WeakMap(), _ResponseStream_currentResponseSnapshot = new WeakMap(), _ResponseStream_finalResponse = new WeakMap(), _ResponseStream_instances = new WeakSet(), _ResponseStream_beginRequest = function _ResponseStream_beginRequest() {
            ...
            case 'response.output_text.delta':
                {
                    ...
                    if (!output) {
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing output at index ".concat(event.output_index));
                    }
                    if (output.type === 'message') {
                        const content = output.content[event.content_index];
                        if (!content) {
                            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing content at index ".concat(event.content_index));
                        }
                        if (content.type !== 'output_text') {
                            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("expected content to be 'output_text', got ".concat(content.type));
                        }
        ...
        if (!snapshot) {
            if (event.type !== 'response.created') {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("When snapshot hasn't been set yet, expected 'response.created' event, got ".concat(event.type));
            }
...
class Responses extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
    ...
    retrieve(responseId) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        var _query_stream;
        return this._client.get("/responses/".concat(responseId), {
            query,
            ...options,
            stream: (_query_stream = query === null || query === void 0 ? void 0 : query.stream) !== null && _query_stream !== void 0 ? _query_stream : false
        });
    }
    /**
     ...
     */ del(responseId, options) {
        return this._client.delete("/responses/".concat(responseId), {
            ...options,
            headers: {
                Accept: '*/*',
                ...options === null || options === void 0 ? void 0 : options.headers
     ...
     */ cancel(responseId, options) {
        return this._client.post("/responses/".concat(responseId, "/cancel"), {
            ...options,
            headers: {
                Accept: '*/*',
                ...options === null || options === void 0 ? void 0 : options.headers
...
class OutputItems extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(evalId, runId, outputItemId, options) {
        return this._client.get("/evals/".concat(evalId, "/runs/").concat(runId, "/output_items/").concat(outputItemId), options);
    }
    list(evalId, runId) {
        let query = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, options = arguments.length > 3 ? arguments[3] : void 0;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isRequestOptions"])(query)) {
        ...
        return this._client.getAPIList("/evals/".concat(evalId, "/runs/").concat(runId, "/output_items"), OutputItemListResponsesPage, {
            query,
            ...options
        });
    }
...
class Runs extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(evalId, body, options) {
        return this._client.post("/evals/".concat(evalId, "/runs"), {
            body,
            ...options
        });
    }
     ...
     */ retrieve(evalId, runId, options) {
        return this._client.get("/evals/".concat(evalId, "/runs/").concat(runId), options);
    }
    list(evalId) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isRequestOptions"])(query)) {
        ...
        return this._client.getAPIList("/evals/".concat(evalId, "/runs"), RunListResponsesPage, {
            query,
            ...options
        });
    }
     ...
     */ del(evalId, runId, options) {
        return this._client.delete("/evals/".concat(evalId, "/runs/").concat(runId), options);
    }
    /**
     * Cancel an ongoing evaluation run.
     */ cancel(evalId, runId, options) {
        return this._client.post("/evals/".concat(evalId, "/runs/").concat(runId), options);
    }
    constructor(){
        super(...arguments);
...
class Evals extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(evalId, options) {
        return this._client.get("/evals/".concat(evalId), options);
    }
    /**
     * Update certain properties of an evaluation.
     */ update(evalId, body, options) {
        return this._client.post("/evals/".concat(evalId), {
            body,
            ...options
        });
    }
     ...
     */ del(evalId, options) {
        return this._client.delete("/evals/".concat(evalId), options);
    }
    constructor(){
        super(...arguments);
...
class Content extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(containerId, fileId, options) {
        return this._client.get("/containers/".concat(containerId, "/files/").concat(fileId, "/content"), {
            ...options,
            headers: {
                Accept: 'application/binary',
                ...options === null || options === void 0 ? void 0 : options.headers
...
class Files extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(containerId, body, options) {
        return this._client.post("/containers/".concat(containerId, "/files"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["multipartFormRequestOptions"]({
            body,
            ...options
        }));
    }
     ...
     */ retrieve(containerId, fileId, options) {
        return this._client.get("/containers/".concat(containerId, "/files/").concat(fileId), options);
    }
    list(containerId) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isRequestOptions"])(query)) {
        ...
        return this._client.getAPIList("/containers/".concat(containerId, "/files"), FileListResponsesPage, {
            query,
            ...options
        });
    }
     ...
     */ del(containerId, fileId, options) {
        return this._client.delete("/containers/".concat(containerId, "/files/").concat(fileId), {
            ...options,
            headers: {
                Accept: '*/*',
                ...options === null || options === void 0 ? void 0 : options.headers
...
class Containers extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(containerId, options) {
        return this._client.get("/containers/".concat(containerId), options);
    }
    list() {
        let query = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, options = arguments.length > 1 ? arguments[1] : void 0;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isRequestOptions"])(query)) {
     ...
     */ del(containerId, options) {
        return this._client.delete("/containers/".concat(containerId), {
            ...options,
            headers: {
                Accept: '*/*',
                ...options === null || options === void 0 ? void 0 : options.headers
...
class OpenAI extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["APIClient"] {
     ...
     */ constructor({ baseURL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readEnv"]('OPENAI_BASE_URL'), apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readEnv"]('OPENAI_API_KEY'), organization = (_Core_readEnv = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readEnv"]('OPENAI_ORG_ID')) !== null && _Core_readEnv !== void 0 ? _Core_readEnv : null, project = (_Core_readEnv1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readEnv"]('OPENAI_PROJECT_ID')) !== null && _Core_readEnv1 !== void 0 ? _Core_readEnv1 : null, ...opts } = {}){
        if (apiKey === undefined) {
        ...
        if (!options.dangerouslyAllowBrowser && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isRunningInBrowser"]()) {
...
class AzureOpenAI extends OpenAI {
    buildRequest(options) {
        ...
        if (_deployments_endpoints.has(options.path) && options.method === 'post' && options.body !== undefined) {
            var _options___metadata;
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isObj"](options.body)) {
                throw new Error('Expected request body to be an object');
            }
            const model = this.deploymentName || options.body['model'] || ((_options___metadata = options.__metadata) === null || _options___metadata === void 0 ? void 0 : _options___metadata['model']);
    ...
    async _getAzureADToken() {
        if (typeof this._azureADTokenProvider === 'function') {
            ...
            if (!token || typeof token !== 'string') {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Expected 'azureADTokenProvider' argument to return a string but it returned ".concat(token));
            }
            return token;
        }
        return undefined;
     ...
     * @param {Core.DefaultQuery} opts.defaultQuery - Default query parameters to include with every request to the API.
     * @param {boolean} [opts.dangerouslyAllowBrowser=false] - By default, client-side use of this library is not allowed, as it risks exposing your secret API credentials to attackers.
     */ constructor({ baseURL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readEnv"]('OPENAI_BASE_URL'), apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readEnv"]('AZURE_OPENAI_API_KEY'), apiVersion = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readEnv"]('OPENAI_API_VERSION'), endpoint, deployment, azureADTokenProvider, dangerouslyAllowBrowser, ...opts } = {}){
        if (!apiVersion) {
